...
class _AdmitStudentState extends State<AdmitStudent> {
  ...
  Future<void> sendStudentData(BuildContext context) async {
    ...
    Map<String, dynamic> studentData = {
      ...
      'image_path': _image != null ? _image!.path : null,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Student data saved successfully.'),backgroundColor: Colors.green,),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save student data. Status code: ${response.statusCode}'),backgroundColor: Colors.red,duration: Duration(seconds: 4),),
        );
        print('Failed to save student data. Status code: ${response.statusCode}');
      }
    } catch (e) {
      Navigator.pop(context); // Close the dialog
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error sending student data: $e'),backgroundColor: Colors.red,duration: Duration(seconds: 4),),
      );
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _firstNameController, validator: (value) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _lastNameController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _classController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _sectionController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                          ...
                          isExpanded: true,
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      text("Date of birth   (dd/mm/yyyy)", 11, FontWeight.w600, Colors.black45),
                                      SizedBox(height: 6,),
                                      textField(controller: _dobController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _rollNoController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _admissionNoController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _emailController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _fatherNameController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _motherNameController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _fatherOccupationController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _motherOccupationController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _fatherCellNoController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _motherCellNoController, validator: (value) {
                                        if (value == null || value.isEmpty) {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6,),
                                      textField(controller: _addressController, validator: (value) {
                                        if (value == null || value.isEmpty) {
